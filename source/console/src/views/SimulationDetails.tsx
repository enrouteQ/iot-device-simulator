...
export default function SimulationDetails(props: IPageProps): JSX.Element {
    ...
    return shouldRedirect ? (
        ...
        <div className='page-content'>
            ...
            {sim?.simId.includes(simTypes.autoDemo) || sim?.simId.includes(simTypes.flespiTest) ?
                                    ...
                                    <Col>
                                        ...
                                        >
                                            <Dropdown.Item key={-1} href='#'
                                                           onClick={() => setActiveDevice({id: "All", name: "All"})}>
                                                {I18n.get("all")}
                                            </Dropdown.Item>
                                            ...
                                            {messages
                                                ...
                                                .map((message, j) => (
                                                    <Card key={`${i}-${j}`} className='mb-4'>
                                                        <Card.Title
                                                            className='content-card-title pl-2 pt-2'>{message.timestamp}</Card.Title>
